  ...
  <div style={s.fieldGroup}>
    ...
    <div
      style={{
        ...
        boxShadow: focused ? '0 0 0 4px rgba(26,54,45,0.06)' : 'none',
      }}
    >
...
const s = {
  ...
  leftOverlay: { position: 'absolute', inset: 0, background: 'linear-gradient(180deg, rgba(26,54,45,0.2) 0%, rgba(26,54,45,0.6) 100%)' },
  ...
  content: { maxWidth: '400px', width: '100%', position: 'relative' },
  ...
  dividerContainer: { display: 'flex', alignItems: 'center', margin: '24px 0', gap: '16px' },
